...
export const NavButtons = () => {
  return (
    <div className="flex items-center gap-6">
      ...
      <button className="hidden md:block font-label-mono text-label-mono uppercase hover:text-primary border tracking-widest hover:border-on-surface px-6 py-2 rounded border-primary-container text-primary-container duration-300 transition-all">
        Download CV
      </button>
